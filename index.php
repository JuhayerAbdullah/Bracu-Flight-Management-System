...
body {
	...
	background: #6B0529;  
background: -webkit-linear-gradient(to right,#0FC34C, #6B0529);  
background: linear-gradient(to right,#0FC34C, #6B0529); 
}
...
<div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;">
   <!-- <h2 class="text-center mb-3 mt-3 display-4"
	   style="font-style: normal;font-size:80px;">Main Attractions In Bangladesh</h2>   
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			BRACU Flight Management</h5></em>
	<div class="text-light text-center">&copy; <?php echo date('Y')?> CSE470 Flight Management<br><br></div>
	<!-- <p>----------</p> -->
