  ...
  <div class="col-md-6 bg-light form-box">
    <form action="includes/feedback.inc.php" method="POST">
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">What was your first impression
                  when you entered the system?</label>     
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Is there anything missing on this system?</label>     
...
<footer>
	...
	<p class="text-light text-center">&copy; <?php echo date('Y');?> CSE470 Flight Management</p>
</footer>